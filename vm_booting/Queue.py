...
class Receiver:
    def __init__(self, url, queue_name, routing_key, exchange_name='topic_exchange', exchange_type='topic',
                 retry_interval=5):
...
class Publisher:
    def __init__(selfself, url, queue_name, routing_key, exchange_name='topic_exchange', exchange_type='topic',
                 publish_interval=1):
